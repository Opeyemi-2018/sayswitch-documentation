...
const config = {
  logo: <Image src="/assets/img/say-switchlogo.png" alt="Logo" width="110" height="50" />,
  project: {
  ...
  head: (
    ...
    <title>Sayswitch - Developer Documentation</title>
      ...
      <meta name="og:description" content="Integrate payments and financial services into your applications with Sayswitch." />
    </>
  ),
  color: {
