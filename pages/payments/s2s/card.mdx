...
{
    "data" :{
        "number": "8365920590274095730",
        "expiryMonth": "02",
        "expiryYear": "26",
        "cvv" : "789"
    },
    "reference": "1257846579098812"
}
```
...
### 2. Sending the payment request  the Sayswitch API
...
`https://backendapi.sayswitchgroup.com/api/i5678930tyuhjns-cardotp`
...
- **Initial Request:** Submit card transaction details
- **OTP Generation:** System sends OTP to customer's registered phone number
- **User Redirect:** Customer is directed to SaySwitch checkout page
- **OTP Verification:** Customer enters OTP to complete transaction
- **Transaction Processing:** Payment is processed by the financial institution
- **Verification:** Use the verification endpoint to check final transaction status
