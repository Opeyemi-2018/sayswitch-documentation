...
### Endpoint
`POST https://backendapi.sayswitchgroup.com/api/v1/Initialize/transaction/initialize`
...
```
### Endpoint
`GET https://backendapi.sayswitchgroup.com/api/s2s/your_referenceId`
### Example usage
``` http
https://backendapi.sayswitchgroup.com/api/s2s/SSW_17482573443162479
```
### Success Response
```js 
{
